...
class BmiKeyboard extends StatelessWidget {
  final BmiSelectedVariable selectedVariable ;

  BmiKeyboard(this.selectedVariable);
  ...
  buttonPressed(String buttonText, BuildContext context, BmiSelectedVariable selectedVariable) {
    String displayedText = Provider.of<BmiProvider>(context,listen: false).getValue(selectedVariable);
    if (buttonText == 'AC') {
      displayedText = '0';
    } else if (buttonText == '⌫') {
    ...
    Provider.of<BmiProvider>(context,listen: false).changeValue(displayedText, selectedVariable);
   }
}
